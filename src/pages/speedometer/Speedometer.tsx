...
import { Standard, Offroad, Formula1, Beetle13, LCD, Cyberpunk, Bajapunk } from './themes';
...
export function Speedometer() {
	...
	const [gauges] = useState<React.FC[]>([Standard, Offroad, Formula1, Beetle13, LCD, Cyberpunk, Bajapunk]);
